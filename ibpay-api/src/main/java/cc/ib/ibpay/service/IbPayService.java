...
/*    @Value("${server.host}")
    ...
    public boolean checkSign(NotifyReqVO notifyReqVO){
        ...
        //计算的sign为
        String text = (notifyReqVO.getAmount()==null?"":notifyReqVO.getAmount()) + (notifyReqVO.getBlockHigh()==null?"":notifyReqVO.getBlockHigh() )+ (notifyReqVO.getBusinessId()==null?"":notifyReqVO.getBusinessId() )+ (notifyReqVO.getConfirmHeight()==null?"":notifyReqVO.getConfirmHeight()) + (notifyReqVO.getCreateTime()==null?"":notifyReqVO.getCreateTime()) +(notifyReqVO.getCurrency()==null?"":notifyReqVO.getCurrency()) +(notifyReqVO.getErrorMsg()==null?"":notifyReqVO.getErrorMsg()) +(notifyReqVO.getFee()==null?"":notifyReqVO.getFee()) +(notifyReqVO.getFeeCurrency()==null?"":notifyReqVO.getFeeCurrency()) + (notifyReqVO.getFromAddress()==null?"":notifyReqVO.getFromAddress()) +(notifyReqVO.getMaxConfirmHeight()==null?"":notifyReqVO.getMaxConfirmHeight()) +(notifyReqVO.getNonce()==null?"":notifyReqVO.getNonce()) +(notifyReqVO.getTimestamp()==null?"":notifyReqVO.getTimestamp()) +(notifyReqVO.getToAddress()==null?"":notifyReqVO.getToAddress()) +(notifyReqVO.getTradeId()==null?"":notifyReqVO.getTradeId()) +(notifyReqVO.getTradeType()==null?"":notifyReqVO.getTradeType()) +(notifyReqVO.getTxid()==null?"":notifyReqVO.getTxid()) +(notifyReqVO.getTxTime()==null?"":notifyReqVO.getTxTime()) + userApiKey;
